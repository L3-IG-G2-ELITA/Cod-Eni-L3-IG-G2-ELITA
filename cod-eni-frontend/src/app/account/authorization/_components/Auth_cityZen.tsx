...
const AuthCityZen = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#EBECF2]">
      <div className="bg-white p-10 rounded-3xl shadow-md flex flex-col items-center">
        <div className="flex flex-col items-center mb-6">
          <div className="text-[#072BF2] mt-6">
            <svg
              id="logo-82"
              width="60"
              height="60"
          ...
          <h1 className="text-xl font-bold mt-4">Se connecter</h1>
          <p className="text-gray-600 text-[16px]">
            Continuer avec Cityzen connecte
          </p>
        </div>
        <div className="w-full flex items-center">
          <Link
            className="flex items-center w-full pt-2 pb-2 pr-5  pl-5 border border-gray-300 rounded-2xl hover:bg-gray-100"
            href="/profile"
          >
            <div className="bg-[#D9D9D9] text-white p-3 rounded-full">
              <Image src="/user.svg" alt="user button" width={30} height={30} />
            </div>
            <div className="text-start ml-4">
              <h3 className="text-lg font-semibold">
                {session?.data?.user?.name || "Name user"}
              </h3>
              <p className="text-gray-500 font-semibold opacity-45 text-[15px]">
