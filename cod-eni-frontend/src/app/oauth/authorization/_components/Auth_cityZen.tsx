...
const AuthCity = () => {
  ...
  return (
    <div className="flex justify-center  items-center h-screen  bg-[#EBECF2]">
      <div className="flex flex-col border-[#D9D9D9] border-[1px] rounded-3xl w-[50%] pt-9 pb-10 pr-6 pl-6  bg-white space-y-6 items-center">
        <div className="flex space-x-3 items-center">
          <svg
            className="text-[#072BF2]"
            id="logo-82"
            width="60"
            height="60"
            viewBox="0 0 40 28"
        ...
        <p className="text-center">
          Veux-tu accéder à notre service ?
          <span className="text-[#072BF2]">
        ...
        <div className="flex space-x-5">
          <Link href="">
            <Button
              variant="outline"
              className="hover:bg-[#d5c0c0]  hover:text-black hover:border-[#d5c0c0] rounded-3xl"
            >
              Refuser
            </Button>
          </Link>
          <Link href="">
            <Button className="bg-[#072BF2] text-white hover:bg-[#5541D9] rounded-3xl">
              Accepter
            </Button>
          </Link>
        </div>
