...
const StepCard = (props: Props) => {
  ...
  return (
    <div className={`flex w-[80%] space-x-8 ml- ${marginClasses}`}>
      <h3 className="text-[#072BF2] font-bold text-5xl pt-2">.{props.rank}</h3>
      <div className=" flex flex-col rounded-xl bg-white pt-4 pb-4 pl-7 pr-7  space-y-3 w-[70%]">
        <h2 className="font-bold text-lg">{props.item.title}</h2>
